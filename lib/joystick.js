...
var Controllers = {
  ANALOG: {
    ...
    toAxis: {
      value: function(raw) {
        return __.constrain(__.fscale(raw, 0, 1023, -1, 1), -1, 1);
      }
    }
  },
  ESPLORA: {
...
function Joystick(opts) {
  ...
  if (typeof this.initialize === "function") {
    this.initialize(opts, function(data) {
      ...
      Object.keys(data).forEach(function(axis) {
        ...
        sensor.value = value - sensor.zeroV;
  ...
  Object.defineProperties(this, {
    ...
    x: {
      get: function() {
        return this.toAxis(state.x.value) * (state.x.invert ? -1 : 1);
      }
    },
    y: {
      get: function() {
        return this.toAxis(state.y.value) * (state.y.invert ? -1 : 1);
      }
    }
  });
}
